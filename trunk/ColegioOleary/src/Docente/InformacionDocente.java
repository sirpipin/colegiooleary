...
public class InformacionDocente extends javax.swing.JDialog implements  
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(capturaCedula, javax.swing.GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel19)
                            .addComponent(capturaCedula, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel20)
 ...
 ActualizaDocente.RecibeDocente(nombreD1.getText(),apellidoD1.getText(),capturaCedula.getText(),
                                direccionD1.getText(),telefonoD1.getText(),
                               emailD1.getText(),celularD1.getText(),
                               capturaEstatus.getText());
        ...
        task.execute();
	     ...
	     Connection conn=null;
          ...
          sw = 0;
             ...
             sw = 0;
                        while(sw ==0){
                            datos.setcedula(capturaCedula.getText());
                       /* if( cedula.length()<1){
             ...
             while(sw == 0){
                     ...
                     datos.setstatus(capturaEstatus.getText());
             ...
             String sqlRemoto = "INSERT INTO docente(nombre, apellido, cedula,direccion,email,celular,telefono,status) VALUES('" + datos.getNombre() + "', '" + datos.getapellido() + "', '" + datos.getcedula() + "','" + datos.getDireccion() + "', '" + datos.getcelular() + "', '" + datos.getEmail() + "', '" + datos.getTelefono() + "','" + datos.getstatus() + "')";
